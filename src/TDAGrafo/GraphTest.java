...
/**
* Tester desarrollado con JUnit 4 para la estructura GraphD (no dirigido).
* 
...
public class GraphTest {
	...
	private GraphD<Object, Object> GraphD;
	private Object o1;
	...
	@Before
	public void setUp() {
		GraphD =new  DirectedGraph <Object, Object>(); // cambiar esta línea para probar
	...
	public void tearDown() {
		GraphD = null; // esto es importante ya que los objetos pueden
	 ...
	 */
	@Test
	public void vertices_emptyGraphD_returnsEmptyCollection() {
		Iterable<Vertex<Object>> vertices = GraphD.vertices();
	 ...
	 */
	@Test
	public void edges_emptyGraphD_returnsEmptyCollection() {
		Iterable<Edge<Object>> edges = GraphD.edges();
	...
	public void incidentEdges_vertexWithoutEdges_returnsEmptyCollection() throws InvalidVertexException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		Iterable<Edge<Object>> incidentEdges = GraphD.incidentEdges(v1);
	...
	public void opposite_nullVertex_throwsIVE() throws InvalidVertexException, InvalidEdgeException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		Edge<Object> e = GraphD.insertEdge(v1, v2, new Object());
		GraphD.opposite(null, e);
	}
	...
	public void opposite_edgeNotConnected_throwsIEE() throws InvalidEdgeException, InvalidVertexException {
		...
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		Edge<Object> e = GraphD.insertEdge(v1, v2, new Object());
		Vertex<Object> v3 = GraphD.insertVertex(new Object());
		GraphD.opposite(v3, e);
	}
	...
	public void endVertices_normalBehavior_returnsEndVertexs() throws InvalidVertexException, InvalidEdgeException {
		...
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		Edge<Object> e = GraphD.insertEdge(v1, v2, new Object());
		Vertex<Object> endVertices[] = GraphD.endvertices(e);
	...
	public void areAdjacent_notAdjacentsVertexs_returnsFalse() throws InvalidVertexException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		assertFalse("El método areAdjacent retorna true para dos vértices no adyacentes.", GraphD.areAdjacent(v1, v2));
	}
	...
	public void replace_nullVertex_throwsIVE() throws InvalidVertexException {
		GraphD.replace(null, new Object());
	}
	 ...
	 */
	@Test
	public void insertVertex_emptyGraphD_returnsInsertedVertex() throws InvalidVertexException {
		Vertex<Object> v1 = GraphD.insertVertex(o1);
	 ...
	 */
	@Test
	public void insertVertex_emptyGraphD_newVertexInGraphD() throws InvalidVertexException {
		Vertex<Object> v1 = GraphD.insertVertex(o1);
		Iterable<Vertex<Object>> vertices = GraphD.vertices();
		Iterator<Vertex<Object>> verticesIterator = vertices.iterator();
	...
	public void insertEdge_firstVertexNull_throwsIVE() throws InvalidVertexException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		GraphD.insertEdge(null, v1, new Object());
	}
	...
	public void insertEdge_secondVertexNull_throwsIVE() throws InvalidVertexException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		GraphD.insertEdge(v1, null, new Object());
	}
	...
	public void insertEdge_bothVerticesNull_throwsIVE() throws InvalidVertexException {
		GraphD.insertEdge(null, null, new Object());
	}
	 ...
	 */
	@Test
	public void insertEdge_emptyGraphD_returnsInsertedEdge() throws InvalidVertexException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		Edge<Object> e = GraphD.insertEdge(v1, v2, o1);
	 ...
	 */
	@Test
	public void insertEdge_emptyGraphD_newEdgeInGraphD() throws InvalidVertexException, InvalidEdgeException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		Edge<Object> e = GraphD.insertEdge(v1, v2, o1);
		Iterable<Edge<Object>> edges = GraphD.edges();
	 ...
	 */
	@Test
	public void insertEdge_emptyGraphD_EdgeInV1AdjacencyList() throws InvalidVertexException, InvalidEdgeException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		Edge<Object> e = GraphD.insertEdge(v1, v2, o1);
		Iterable<Edge<Object>> incidentEdgesV1 = GraphD.incidentEdges(v1);
	 ...
	 */
	@Test
	public void insertEdge_emptyGraphD_EdgeInV2AdjacencyList() throws InvalidVertexException, InvalidEdgeException {
		Vertex<Object> v1 = GraphD.insertVertex(new Object());
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		Edge<Object> e = GraphD.insertEdge(v1, v2, o1);
		Iterable<Edge<Object>> incidentEdgesV2 = GraphD.incidentEdges(v2);
	...
	public void removeVertex_validVertex_returnsElement() throws InvalidVertexException {
		Vertex<Object> v1 = GraphD.insertVertex(o1);
		Object element = GraphD.removeVertex(v1);
	...
	public void removeEdge_validEdge_returnsElement() throws InvalidVertexException, InvalidEdgeException {
		...
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		Edge<Object> e = GraphD.insertEdge(v1, v2, o1);
		Object element = GraphD.removeEdge(e);
	...
	public void removeEdge_validEdge_removedFromPredecessorIncidentEdges() throws InvalidVertexException, InvalidEdgeException {
		...
		Edge<Object> e = GraphD.insertEdge(v1, v2, new Object());
		GraphD.removeEdge(e);
		Iterable<Edge<Object>> edgesV1 = GraphD.incidentEdges(v1);
	...
	public void removeEdge_validEdge_removedFromSuccessorIncidentEdges() throws InvalidVertexException, InvalidEdgeException {
		...
		Edge<Object> e = GraphD.insertEdge(v1, v2, new Object());
		GraphD.removeEdge(e);
		Iterable<Edge<Object>> edgesV2 = GraphD.incidentEdges(v2);
	...
	public void simulation() throws InvalidVertexException, InvalidEdgeException {
		...
		Vertex<Object> v2 = GraphD.insertVertex(new Object());
		for (int i = 0; i < 100; i++) {
			GraphD.insertVertex(new Object());
		}
		Vertex<Object> v3 = GraphD.insertVertex(new Object());
		Vertex<Object> v4 = GraphD.insertVertex(new Object());
		...
		Edge<Object> e1 = GraphD.insertEdge(v1, v2, new Object());
		Edge<Object> e2 = GraphD.insertEdge(v1, v3, new Object());
		Edge<Object> e3 = GraphD.insertEdge(v3, v4, new Object());
		
		assertTrue("areAdjacent retorna false para dos vértices adyacentes.", GraphD.areAdjacent(v1, v2));
		assertTrue("areAdjacent retorna false para dos vértices adyacentes.", GraphD.areAdjacent(v1, v3));
		assertTrue("areAdjacent retorna false para dos vértices adyacentes.", GraphD.areAdjacent(v3, v4));
		assertFalse("areAdjacent retorna true para dos vértices no adyacentes.", GraphD.areAdjacent(v1, v4));
		assertFalse("areAdjacent retorna true para dos vértices no adyacentes.", GraphD.areAdjacent(v2, v3));
		assertFalse("areAdjacent retorna true para dos vértices no adyacentes.", GraphD.areAdjacent(v2, v4));
		
		assertEquals("opposite no retorna el vértice opuesto correctamente.", v3, GraphD.opposite(v1, e2));
		assertEquals("opposite no retorna el vértice opuesto correctamente.", v1, GraphD.opposite(v3, e2));
		assertEquals("opposite no retorna el vértice opuesto correctamente.", v1, GraphD.opposite(v2, e1));
		assertEquals("opposite no retorna el vértice opuesto correctamente.", v2, GraphD.opposite(v1, e1));
		assertEquals("opposite no retorna el vértice opuesto correctamente.", v4, GraphD.opposite(v3, e3));
		assertEquals("opposite no retorna el vértice opuesto correctamente.", v3, GraphD.opposite(v4, e3));
		
		Iterable<Edge<Object>> arcos = GraphD.edges();
		...
		GraphD.removeEdge(e1);
		GraphD.removeEdge(e2);
		assertFalse("areAdjacent retorna true para dos vértices no adyacentes.", GraphD.areAdjacent(v1, v2));
		assertFalse("areAdjacent retorna true para dos vértices no adyacentes.", GraphD.areAdjacent(v1, v3));
		arcos = GraphD.edges();
		iteradorArcos = arcos.iterator();
		contadorArcos = 0;
		while (iteradorArcos.hasNext()) {
